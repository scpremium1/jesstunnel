...
BURIQ () {
    ...
    curl -sS https://raw.githubusercontent.com/scpremium1/jesstunnel/main/register > /root/tmp
...
PERMISSION () {
    ...
    IZIN=$(curl -sS https://raw.githubusercontent.com/scpremium1/jesstunnel/main/register | awk '{print $4}' | grep $MYIP)
...
Exp=$(curl -sS https://raw.githubusercontent.com/scpremium1/jesstunnel/main/register | grep $MYIP | awk '{print $3}')
fi
...
echo -e "\033[1m${BIWhite}┃${NC}${BIYellow} \e[41;97;1m               ◥꧁BY TUNNEL STORE꧂◤                 \033[0m\e[38;5;196m${NC}"
echo -e "\033[1m${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\033[1m${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
...
echo -e "\033[1m${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e "\033[1m${BIWhite}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮\033[0m${NC}"
echo -e "\033[1m${BIWhite}┃${NC} ${BIRed}   ${BIWhite}TERIMAKASIH SUDAH MENGGUNAKAN BY TUNNEL STORE${NC}    ${BIWhite}┃\033[0m${NC}"          
echo -e "\033[1m${BIWhite}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯\033[0m${NC}"
echo -e ""
